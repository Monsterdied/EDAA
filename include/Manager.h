...
class Manager {
    ...
    public:
        ...
        vector<Edge*> shortestPathAstar(Node* startNode, const Coordinates& goal,double max_tentative=10000000000) const;
        vector<pair<double,vector<Edge*>>> shortestPath(const Coordinates& start, const Coordinates& goal,double max_tentative=10000000000,
